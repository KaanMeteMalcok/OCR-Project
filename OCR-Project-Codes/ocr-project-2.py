...
"""
Start_4 = """
Girilen bilgiler doğruysa 1'e basın
Yanlışsa 2'ye basın
"""
key_num = 1
key_num_1 = 1
    ...
    if question == '2':
        ...
        if total_index == -1:
            ...
            if total_number[1] != '1' and total_number[1] != '2' and total_number[1] != '3' and total_number[1] != '4' and total_number[1] != '5' and total_number[1] != '6' and total_number[1] != '7' and total_number[1] != '8' and total_number[1] != '9':
                ...
                total_number = total_number 
        #print(total_number)
        company_name = company_name.replace(Boşluk_1,'')
        tax_number = tax_number.replace(Boşluk_1,'')
        total_number = total_number.replace(Boşluk_1,'')
        company_control = 'Firma adı      : '+company_name
        tax_control = 'Kdv            : '+tax_number
        total_control = 'Harcama tutarı : '+total_number
        print(company_control)
        print(tax_control)
        print(total_control)
        ...
        while key_num_1 == 1:
            ...
            if upload_1 == '3':
                ...
                company_input = company_control+'   -> Firma Adı :'
                tax_input = tax_control+'   -> Kdv :'
                total_input = total_control+'   -> Harcama Tutarı :'
                company_name_1 = input(company_input)
                tax_number_1 = input(tax_input)
                total_number_1 = input(total_input)
                if company_name_1 == '':
                ...
                if tax_number_1 == '':
                    ...
                    tax_number = tax_number_1
                if total_number_1 == '':
                    total_number = total_number
                else:
                    total_number = total_number_1
                while key_num_4 == 1:
                    company_control_end = 'Firma adı      : '+company_name
                    tax_control_end = 'Kdv            : '+tax_number
                    total_control_end = 'Harcama tutarı : '+total_number
                    print('---------------------------------------')
                    print(company_control_end)
                    print(tax_control_end)
                    print(total_control_end)
                    print(Start_4)
                    question_end = input("Yapmak istediğiniz işlemin numarasını giriniz : ")
                    if question_end == '1':
                        tax_number = tax_number.replace(',','.')
                        tax_number = tax_number.replace(Boşluk_1,'')
                        tax_number = tax_number.replace(' ','')
